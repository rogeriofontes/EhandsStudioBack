    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/artistas").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/v1/artistas").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/v1/artistas/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/produtos").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/produtos").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/v1/produtos").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/v1/produtos").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/categorias").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/v1/categorias").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/v1/categorias").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/clientes").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/clientes").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/v1/clientes").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/v1/clientes").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/orcamentos").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/orcamentos").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/v1/orcamentos").permitAll()
